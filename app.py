...
def main():
    ...
    if st.button("House Price in Lakhs"):
        result = predict_price(selected_location, float(sqft), float(bath), float(bhk))
    st.success('The predicted house price is in {} lakhs'.format(result))
